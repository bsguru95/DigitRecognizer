...
class Recognizer {
  ...
  Future<Uint8List> previeImage(List<Offset> points) async {
  ...
  Future recognize(List<Offset> points) async {
    final picture = _pointsToPicture(points);
    Uint8List bytes =
        await _imageToByteListUnit(picture, Constants.mnistImagesize);
  ...
  Future<Uint8List> _imageToByteListUnit(Picture pic, int size) async {
